...
public class ClienteController {
    ...
    @Operation(summary = "Recuperar lista de clientes",
            description = "Requisição exige o uso de um bearer token. Acesso restrito a Role='ADMIN'",
            security = @SecurityRequirement(name = "security"),
            parameters = {
                    ...
                    @Parameter(in = ParameterIn.QUERY, name = "sort", hidden = true,
                            ...
                            description = "Representa a ordenação dos resultados. Aceita multiplo critérios de ordenação"
                    ),
            },
            responses = {
                    @ApiResponse(responseCode = "200", description = "Recurso localizado com sucesso", content = @Content(mediaType = "application/json",
